...
typedef struct {
	// Desired pin functions. Use MCP2221_PIN_FUNC_KEEP to preserve.
	mcp2221_pin_function_t gp[4];

	// Output values for GP0..GP3 if and only if the corresponding gp[i] is MCP2221_PIN_FUNC_GPIO_OUT.
	// Python rules:
