...
#define MCP2221_FLASH_PAYLOAD_SIZE \
	(MCP2221_PACKET_SIZE - MCP2221_FLASH_OFFSET_READ)
#define MCP2221_FLASH_RESPONSE_STRUCTURE_LENGTH_BYTE 2
#define MCP2221_FLASH_RESPONSE_DESCRIPTOR_TYPE_BYTE  3
#define MCP2221_FLASH_PASSWORD_OFFSET                 2u
#define MCP2221_USB_STRING_DESCRIPTOR_HEADER_SIZE     2u
#define MCP2221_USB_STRING_DESCRIPTOR_TYPE            0x03u
...
#define MCP2221_SRAM_RESPONSE_CHIP_LENGTH_BYTE 2u
#define MCP2221_SRAM_RESPONSE_GP_LENGTH_BYTE   3u
#define MCP2221_SRAM_CHIP_SETTINGS_LENGTH      18u
#define MCP2221_SRAM_GP_SETTINGS_LENGTH        4u
...
#define MCP2221_SRAM_RESPONSE_ADC_REF_SHIFT 2u
#define MCP2221_SRAM_RESPONSE_ADC_REF_MASK  (0x07u << MCP2221_SRAM_RESPONSE_ADC_REF_SHIFT)
...
#define MCP2221_I2C_NEWSPEED_NOT_SET                 0x21u
#define MCP2221_RESET_CHIP_SURE					0xAB
#define MCP2221_RESET_CHIP_VERY_SURE			0xCD
#define MCP2221_RESET_CHIP_VERY_VERY_SURE       0xEF
#define MCP2221_GPIO_SET_COMMAND_SIZE          18u
#define MCP2221_GPIO_SET_ALTER_VALUE            1u
#define MCP2221_GPIO_SET_PRESERVE_VALUE         0u
#define MCP2221_GPIO_RESPONSE_NOT_GPIO        0xEEu
#define MCP2221_GPIO_SET_GP0_ALTER_BYTE         2u
#define MCP2221_GPIO_SET_GP0_VALUE_BYTE         3u
#define MCP2221_GPIO_SET_GP1_ALTER_BYTE         6u
#define MCP2221_GPIO_SET_GP1_VALUE_BYTE         7u
#define MCP2221_GPIO_SET_GP2_ALTER_BYTE        10u
#define MCP2221_GPIO_SET_GP2_VALUE_BYTE        11u
#define MCP2221_GPIO_SET_GP3_ALTER_BYTE        14u
#define MCP2221_GPIO_SET_GP3_VALUE_BYTE        15u
